...
def eval_model(args):
    ...
    with open(eval_data_path, "r") as f:
        ...
        for index,data_info in tqdm(enumerate(eval_data_infos)):
            ...
            noisy_masked_fg_img = random_noise(img_as_float(np.array(masked_fg_img)), mode='gaussian', var=0.5)
            noisy_bg_img = random_noise(img_as_float(np.array(bg_img)), mode='gaussian', var=0.5)
